defmodule FCAuth.User do
  ...
  defstruct email: "", password_hash: "", status: "", signup_token: "", signup_token_generated_at: 0, roles: []
  @type t :: %User{
    email: String.t(),
  ...
  @spec to_tuple(t()) :: {String.t(), String.t(), String.t(), String.t(), integer(), list(String.t())}
  ...
  @spec to_struct({String.t(), String.t(), String.t(), String.t(), integer(), list(String.t())}) :: t()
